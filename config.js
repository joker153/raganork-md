...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/mIPSFxH.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '919074300534-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://i.imgur.com/mIPSFxH.jpg;https://chat.whatsapp.com/IIswk80ApaYDYHxgdeDys3',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "MIKASA",
    BOT_NAME: process.env.BOT_NAME || 'MIKASA',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Mikasa;https://i.imgur.com/mIPSFxH.jpg' : process.env.AUDIO_DATA,
